 ...
 * TODO: due to Gerrit workflow and time constraints, some renaming/refactoring
...
struct pme_gpu_t
{
     ...
     * TODO: should also be replaced by a template boolean argument boxChanged to pme_gpu_start_step().
     */
    matrix previousBox;
     ...
     * Can probably be copied to the constant GPU memory once per MD step
     * (or even less often) instead of being an argument.
     */
