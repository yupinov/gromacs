...
\iffalse
We only allow an increase of the cut-off. This increases the cost of the non-bonded pair interactions by the scaling factor cubed and reduces the FFT, grid transpose and communication volume by the scaling factor cubed, thereby essentially increasing the size of the compute dominated task and reducing the size of several memory/communication dominated tasks.
\fi
