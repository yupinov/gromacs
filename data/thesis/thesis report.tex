...
There are 2 important design constraints here:
\begin{itemize}
...
The inter-process parallelization with MPI is employed by all computation stages of the MD step.
...
Some steps, such as  the non-bonded work being split into 2 "local" and "non-local" GPU streams, or inter-process communication, are deliberately omitted from the figure, as they are not sthe focus of the project. 
