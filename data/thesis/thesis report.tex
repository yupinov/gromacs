...
That is why it was chosen to have a grid allocated with additional $(l-1)$ overlap in all 3 dimensions. Instead of having modulo operations for grid indices in the spreading, 
