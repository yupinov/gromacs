...
\item united with the spreading kernel to save on global memory accesses 
\end{itemize}
\end{frame}
...
\begin{itemize}
\item the single GPU implementation provides a foundation for further implementation tuning
